...
SYSTEM_INSTRUCTION = (
    ...
    "These render inside a fixed-size UI box (a button or menu choice). Their translation MUST fit within the limits. "
    "If max_pixels is specified, you should estimate the visual width of the translation (remembering that Cyrillic "
    "characters are visually 10-20% wider than Latin characters) and make sure it does not exceed max_pixels. "
    "If a faithful translation would be longer or wider, REPHRASE it shorter — use a shorter synonym, drop filler words, "
    "abbreviate — and NEVER exceed the limits. For these items fitting the width OVERRIDES sounding natural. "
    "Example: source 'Start a New Game' with max_chars 10 -> 'Новая игра' (not a longer literal translation). "
    "These limits are constraints to OBEY, never text to translate.\n"
