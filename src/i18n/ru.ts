...
const ru: Strings = {
  ...
  proxyUrlPlaceholder: "https://your-proxy.vercel.app/v1",
  ...
  proxyInfoStep1: "1. Откройте github.com/CaHeK20021/interprex-proxy и нажмите \"Deploy to Vercel\"",
  proxyInfoStep2: "2. Войдите через GitHub (бесплатно), заполните PROVIDER и API_KEY, нажмите Deploy (~1 минута)",
  proxyInfoStep3: "3. Скопируйте URL вашего деплоя (напр. https://my-proxy.vercel.app/v1) и вставьте выше",
  proxyInfoStep4: "4. Выберите провайдер (например, Google Gemini) и переводите — при ошибках блокировки запрос пойдет через прокси автоматически.",
  proxyInfoFree: "Полностью бесплатно · Ваш ключ, ваши данные · Работает с Gemini, OpenAI, Mistral, Groq и другими",
