...
const en = {
  ...
  proxyInfoStep1: "1. Open github.com/CaHeK20021/interprex-proxy and click \"Deploy to Vercel\"",
  proxyInfoStep2: "2. Sign in with GitHub (free), fill in PROVIDER and API_KEY, click Deploy (~1 min)",
  proxyInfoStep3: "3. Copy your deployment URL (e.g. https://my-proxy.vercel.app/v1) and paste it above",
  proxyInfoStep4: "4. Choose a provider (e.g. Google Gemini) and translate — if a geo-block occurs, request will route via proxy automatically.",
  proxyInfoFree: "Completely free · Your key, your data · Works with Gemini, OpenAI, Mistral, Groq and more",
